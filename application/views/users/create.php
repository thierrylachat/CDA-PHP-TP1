			...
			<div class="form-group">
				...
				<div>
					<select id="birthCountry" name="birthCountry" class="custom-select">
						...
						<option value="<?= $country->code?>" <?php echo set_select('birthCountry', $country->code) ?>>
							<?= $country->langFR?></option>
						<?php }?>
					</select>
			...
			<div class="form-group">
				...
				<div>
					<div class="custom-control custom-checkbox custom-control-inline">
						<input name="diploma" id="diploma_0" type="checkbox" class="custom-control-input" value="0"
							<?php echo set_checkbox('diploma', '0'); ?>>
						<label for="diploma_0" class="custom-control-label">sans</label>
					</div>
					<div class="custom-control custom-checkbox custom-control-inline">
						<input name="diploma" id="diploma_1" type="checkbox" class="custom-control-input" value="1"
							<?php echo set_checkbox('diploma', '1'); ?>>
						<label for="diploma_1" class="custom-control-label">Bac</label>
					</div>
					<div class="custom-control custom-checkbox custom-control-inline">
						<input name="diploma" id="diploma_2" type="checkbox" class="custom-control-input" value="2"
							<?php echo set_checkbox('diploma', '2'); ?>>
						<label for="diploma_2" class="custom-control-label">Bac+2</label>
					</div>
					<div class="custom-control custom-checkbox custom-control-inline">
						<input name="diploma" id="diploma_3" type="checkbox" class="custom-control-input" value="3"
							<?php echo set_checkbox('diploma', '3'); ?>>
